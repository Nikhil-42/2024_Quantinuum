...
var x = {real: [[-0.75732054, -0.57956813],[0.51218892, -0.804903]], imaginary: [[-0.2738093, 0.12487934 ], [0.29859097, 0.02524081]] };
...
function displayComplexMatrix(matrix) {
  ...
  for (var i = 0; i < matrix['real'].length; i++) {
    for (var j = 0; j < matrix['real'][i].length; j++) {
      var complexNumber = {'real': matrix['real'][i][j], 'imaginary': matrix['imaginary'][i][j]};
